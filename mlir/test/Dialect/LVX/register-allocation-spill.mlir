...
// CHECK-NEXT: %6 = lvx.addd %5, %4 : (<r61>, <r0>) -> <r61>
// CHECK-NEXT: lvx.sd %6, %2, 8 : (<r61>, <r12>)
// CHECK-NEXT: %7 = lvx.ld %2, 0 : (!lvx.reg<r12>) -> !lvx.reg<r61>
// CHECK-NEXT: %8 = lvx.ld %2, 8 : (!lvx.reg<r12>) -> !lvx.reg<r62>
// CHECK-NEXT: %9 = lvx.muld %8, %7 : (<r62>, <r61>) -> <r0>
...
// CHECK: lvx.sd %{{[0-9]+}}, %{{[0-9]+}}, 8 : (<r61>, <r12>)
// CHECK: lvx.sd %{{[0-9]+}}, %{{[0-9]+}}, 16 : (<r61>, <r12>)
// CHECK: ^bb1:
